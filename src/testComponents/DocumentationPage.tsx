...
const linkMap: Record<string, string> = {
  ...
  actionsDropdownItems: 'IActionsDropdownItems',
  actionColumnSetting: 'IActionColumnSetting',
  onDataChange: 'IDataChange',
...
const iFilterConfigProps: PropDefinition[] = [
  { name: 'type',                 type: 'string',        description: 'Type of filter (e.g., text, date).',              defaultValue: '—' },
  { name: 'value',                type: 'any',           description: 'Current filter value.',                           defaultValue: '—' },
  { name: 'multiSelect',          type: 'boolean',       description: 'Allow multi-select values.',                      defaultValue: '—' },
  { name: 'options',              type: 'IOptions[]',    description: 'Dropdown options list.',                          defaultValue: '—' },
  { name: 'codeId',               type: 'string',        description: 'Field used as option value.',                     defaultValue: '—' },
...
const columnSettingsInterfaces: { title: string; props: PropDefinition[] }[] = [
  ...
  { title: 'IActionsDropdownItems', props: iActionsDropdownItemsProps },
  { title: 'IActionColumnSetting', props: iActionColumnSettingProps },
  { title: 'IDataChange',          props: iDataChangeProps },
  { title: 'IFilterConfig',        props: iFilterConfigProps },
];
